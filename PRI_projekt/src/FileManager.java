...
public class FileManager {
    ...
    public ArrayList<double[]> chooseFileToLoad(InputDataType type) throws FileNotFoundException {
        return switch (type) {
    ...
    public ArrayList<double[]> loadData(String filename) throws FileNotFoundException {
...
//        }
    ...
    public double[] parseStringArrToDoubleArr(String[] stringArray) {
