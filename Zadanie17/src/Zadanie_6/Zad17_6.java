...
public class Zad17_6 {
    public static char[][] generateMaze(char maze[][], int start, int total, int[][] moves, int pos, int[][] dir, int x, int y, int[] posMove, int size) {
        if (start == total) {
            return maze;
        }
        if (start < total) {
        ...
        return generateMaze(maze, start , total, moves, pos, dir, x, y, posMove, size);
    }
    ...
    public static void main(String[] args) {
        ...
        generateMaze(maze, 0, total, moves, pos, dir, x, y, posMove, size);
